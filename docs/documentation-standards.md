...
## Reference Examples
The files in `docs/examples/` serve as reference templates from the LIDR project:
- `api-spec.yml`: Example of OpenAPI 3.0 specification.
- `data-model.md`: Example of database schema and domain models documentation.
- `development_guide.md`: Example of setup and workflow instructions.

When starting a new project, you should create your own versions of these files in the `docs/` folder, using these examples as a guide for the expected structure and detail.
